namespace PoGoChatbot
{
    public static class Constants
    {
        ...
        public const string MaskReminder = "Additionally, please ensure that you are wearing an appropriate mask when raiding anywhere that you might be around other people. It's critically important as Pokémon trainers to set a good example and help keep our community safe and healthy!";
